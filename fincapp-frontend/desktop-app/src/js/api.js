...
const BASE_URL = localStorage.getItem('fincapp_api_base_url') || 'http://localhost:3000/api';
const PYTHON_URL = localStorage.getItem('fincapp_ai_base_url') || 'http://localhost:5000/api';
...
export function getDemoFarms() {
    return [
        ...
        { id: 'Finca El Roble', name: 'Finca El Roble' },
        { id: 'Finca La Esperanza', name: 'Finca La Esperanza' },
...
function demoDataset() {
    return {
        ...
        'Finca El Roble': {
            farm_id: 'Finca El Roble', total_animals: 7,
        ...
        'Finca La Esperanza': {
            farm_id: 'Finca La Esperanza', total_animals: 5,
